...
function Footer() {
  return (
    <footer style={{ background: '#0a0a0a', borderTop: '1px solid #222' }}>
        ...
        <div style={{ padding: '48px 0', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '48px' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '16px', marginTop: '20px' }}>
              <a href="#" target="_blank" rel="noopener noreferrer" style={{ color: '#888', transition: 'color 0.2s' }}>
      ...
      {/* 이미지 섹션 */}
      <div style={{ width: '100%', height: '450px', background: '#1a1a1a', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <p style={{ color: '#444', fontSize: '14px' }}>이미지 영역</p>
      </div>
    </footer>
  )
}
