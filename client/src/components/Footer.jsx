  ...
  return (
    <footer style={{ background: '#0a0a0a', borderTop: '1px solid #222' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 80px' }}>
        {/* 메인 푸터 */}
        <div style={{ padding: '48px 0', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '48px' }}>
          {/* 브랜드 */}
          <div>
            <Link to="/" style={{ fontSize: '20px', fontWeight: 300, letterSpacing: '0.3em' }}>
              구의정원
            </Link>
            <p style={{ marginTop: '16px', fontSize: '14px', color: '#888', lineHeight: 1.8 }}>
              자연을 담은 작은 정원,<br />
              테라리움과 비바리움 전문 브랜드
            </p>
            {/* 소셜 링크 */}
            <div style={{ display: 'flex', gap: '16px', marginTop: '20px' }}>
              <a href="https://www.instagram.com/gu.garden/" target="_blank" rel="noopener noreferrer" style={{ color: '#888', transition: 'color 0.2s' }}>
              ...
              <a href="https://www.youtube.com/@gugarden" target="_blank" rel="noopener noreferrer" style={{ color: '#888', transition: 'color 0.2s' }}>
                <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor">
          ...
          {/* 쇼핑 */}
          <div>
            <h4 style={{ fontSize: '12px', letterSpacing: '0.2em', color: '#666', marginBottom: '16px' }}>
              SHOP
            </h4>
        ...
        {/* 하단 */}
        <div style={{ padding: '20px 0', borderTop: '1px solid #222', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
